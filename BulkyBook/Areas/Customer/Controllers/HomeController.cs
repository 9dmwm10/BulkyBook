...
namespace BulkyBook.Areas.Customer.Controllers
{
    ...
    public class HomeController : Controller
    {
        ...
        {
            var objectsFromDb = _unitOfWork.Product.GetAll();
        ...
        {
            var productOfDb = _unitOfWork.Product.GetFirstOrDefault(u => u.Id == id, includeProperties: "Category,CoverType");

            ShoppingCart cartObj = new ShoppingCart()
            {
                Product = productOfDb,
                ProductId = productOfDb.Id
            };
        ...
        public IActionResult Details(ShoppingCart cartObject)
        {
            ...
            {
                var productOfDb = _unitOfWork.Product.GetFirstOrDefault(u => u.Id == cartObject.ProductId, includeProperties: "Category,CoverType");
