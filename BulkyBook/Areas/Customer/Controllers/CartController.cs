...
namespace BulkyBook.Areas.Customer.Controllers
{
    ...
    public class CartController : Controller
    {
        ...
        public async Task<IActionResult> IndexPOST()
        {
            ...
            await _emailSender.SendEmailAsync(user.Email, "Confirm you email",
        ...
        public IActionResult Remove(int cartId)
        {
            ...
            _unitOfWork.Save();
            HttpContext.Session.SetInt32(SD.ssShopingCart, HttpContext.Session.GetInt32(SD.ssShopingCart).GetValueOrDefault() - 1);
            return RedirectToAction(nameof(Index));
        }
        ...
        { 
            ...
            List<OrderDetails> ordeDeatilsList = new List<OrderDetails>();
